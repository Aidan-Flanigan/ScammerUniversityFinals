...
**4. Performance Variability Across Models**: Of note as well is the inherent limitations of relying on outside models for the purposes of this study. Spefically, the variability in available parallels, bit rate/cost per bit, and host computing power means that there are often extreme performance differences across platforms. For example, while Gemini was able to fulfill the task at hand in under 30 minutes, other models such as Grok took well over 12 hours to answer all of the provided questions due to the lack of parallels and less powerful infrastructure available for use. Gemini and ChatGPT were capable of handling 50+ parallel operations at once, while Grok only ran 5, with any higher than 10 beginning to risk overloading the model. This also means that models may be more prone to crashing should the user attempt to push the model past the parallels we used for this project. 
...
**3. Variances in Model Use Preferences**: It may also be worth exploring the ways in which users engage with these AI models, as AI has become such an everpresent and extensive part of our lives. Because these models are often trained on how their users interact with them, the method, frequency, and requests users submit to these bots en mass will inevitably influence how these models respond. Models such as Grok are trained heavily on posts on Twitter/X, Gemini through google searches, chatgpt through its many integrations and apps, etc. Understanding the variances in how people use these models, as well as the type of questions they ask, will likely provide insight into how these models are trained to respond to the user. 
